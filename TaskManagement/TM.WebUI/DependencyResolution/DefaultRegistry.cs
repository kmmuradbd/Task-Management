...
namespace TM.WebUI.DependencyResolution {
    ...
    public class DefaultRegistry : Registry {
        ...
        public DefaultRegistry() {
            ...
            For<IMasterMenuRepository>().Use<MasterMenuRepoitory>();
            For<IMasterMenuService>().Use<MasterMenuService>();
